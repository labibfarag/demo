...
var sttEndpoint = vcapServices.speech_to_text[0].credentials.url;
var ttsEndpoint = vcapServices.text_to_speech[0].credentials.url;
...
var tts_credentials =  Object.assign({
  ...
  version: 'v1',
},vcapServices.text_to_speech[0].credentials);
...
if ( cloudantUrl ) {
 ...
 app.get('/list/type1', function(req, res, next){
    res.send('one of list ');
